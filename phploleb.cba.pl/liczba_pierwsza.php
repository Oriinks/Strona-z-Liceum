			...
			<!-- Header -->
				<div id="header-wrapper">
					<div class="container">
						...
						<!-- Banner -->
							<div id="banner">
								<h2><strong>Zadanie:</strong>Sprawdzenie czy dana liczba jest liczbą pierwszą
								<br />
...
Wprowadź liczbę:<br />
											<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
												<input type="text" name="liczba" size="3">
...
{
if($pierwsza%$i==0)$dzielnik++;
}
if(empty($pierwsza)) echo "Wpisz liczbę do sprawdzenia";
else if($dzielnik==2)
echo "Liczba $pierwsza jest liczbą pierwszą";
else echo "Liczba $pierwsza nie jest liczbą pierwszą";
 ?>
</div>
</section>
