...
<html>
			...
			<!-- Header -->
				<div id="header-wrapper">
					<div class="container">
						...
						<!-- Banner -->
							<div id="banner">
								<h2><strong>Zadanie:</strong>Wypisanie ciągu fibonacciego
								<br />
								Poniżej znajduje się algorytm, który wypisuje ciąg fibonacciego z dwóch liczb wpisanych w formularzu.
							</div>
  ...
  Wprowadź liczby: <br /><input type="text" name="liczba1" size="40" />
<br /><input type="text" name="liczba2" size="40" />
	<br /><input type="submit" value="Zamień" />
</form>
</div>
<?php
(int)$liczba1=$_POST['liczba1'];
(int)$liczba2=$_POST['liczba2'];
$T[0]=$liczba1;
$T[1]=$liczba2;
for($i=2;$i<50;$i++)
{
