...
<html>
			...
			<!-- Header -->
				<div id="header-wrapper">
					<div class="container">
						...
						<!-- Banner -->
							<div id="banner">
								<h2><strong>Zadanie:</strong>Zamiana działania na ONP
								<br />
								Poniżej znajduje się algorytm, który ma za zadanie zamienić działanie matematyczne na odwrotną notację polską
							</div>
									...
									<div class="row">
										<div class="12u">
											<header class="first major">
												<h2>ONP - Odwrotna notacja polska</h2>
												<p><strong></strong></p>
											</header>
										</div>
									</div>
  ...
  Wprowadź działanie: <br /><input type="text" name="dzialanie" size="40" />
<br />
...
<?php
	...
	$dlugosc = strlen($dzialanie);


	for($i=0;$i<$dlugosc;$i++)
	{
		if (ord($dzialanie[$i])>47 && ord($dzialanie[$i])<58)   $wynik = $wynik.$dzialanie[$i];
		else if ($wynik[strlen($wynik)-1]!=' ') $wynik = $wynik . " ";

//szukany bląd
		if ( $dzialanie[$i]=='(' ) $stack->push('(');
...
*/
	...
	echo "<h2>Wpisane działanie: $dzialanie</h2>";
	echo "<h2>Działanie w ONP: $wynik</h2>";
	?>
									</div>
									<div class="row">
										<div class="12u">
