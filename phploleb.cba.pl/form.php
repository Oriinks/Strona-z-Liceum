		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				<div id="header-wrapper">
					<div class="container">
						...
						<!-- Banner -->
							<div id="banner">
								<h2><strong>Zadanie:</strong>Adresy IP i działania na nich.
								<br />
								Na podstawie adresu IP obliczyć można wiele informacji.
							</div>
			...
			<!-- Main Wrapper -->
									...
									<div class="row">
										<div class="12u">
											<header class="first major">
												<h2>Informacje adrsu IP</h2>
												<p>Liczba po znaku "/" jest <strong>większa od 24</strong></p>
											</header>
										</div>
									</div>
									<div class="row">
                <div class="4u 12u(mobile)">
                  ...
                  192.168.1.<input type="text" name="liczba1" size="3">/<input type="text" name="liczba2" size="1">
...
$okt4 = $_POST['liczba1'];
$maska = $_POST['liczba2'];
$wynik = "192.168.1." . $okt4 . "/" . $maska;

if ($okt4>=0 && $maska>0)
{
//wyznaczamy maske podsieci
$tmp=32-$maska;
$maskafull="255.255.255.";
$tmp=256-pow(2,$tmp);
$ilead=pow(2,32-$maska);
$ilehost=$ilead-2;
$ilepods=256/$ilead;
$numerpom=floor($okt4/$ilead+1);
$adrespod="192.168.1.".($numerpom-1)*$ilead;
$pomm=$numerpom*$ilead-1;
$adresroz="192.168.1.".$pomm;

echo <<<END
  <div class="4u 12u(mobile)">
Adres IP w postaci CIDR: $wynik<br />
Maska podsieci: $maskafull$tmp<br />
Ilosc adresow: $ilead<br />
Ilosc hostow: $ilehost<br />
Ilosc podsieci: $ilepods<br />
Numer podsieci: $numerpom<br />
Adres podsieci: $adrespod<br />
Adres rozgloszeniowy: $adresroz<br />
  </div>
END;
}
?>
